    ...
    <div className="min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-rose-600 font-light">To My One and Only</p>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-12 border border-rose-200/50">
            ...
            <div className="text-center mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                On this special day, I want to celebrate the incredible journey we've shared together. Your love has
                transformed my life in ways I never imagined possible. Every laugh, every moment, every dream we've
                built together means the world to me.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Here's to many more years of love, laughter,pain, sorrow, fights and unforgettable memories. I love you more than words
                could ever express.
              </p>
            </div>

            <div className="text-center pt-8 border-t border-rose-200">
              <p className="text-rose-600 font-semibold text-lg">Forever Yours,</p>
